...
@override Future<void> crateLaunch()  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
        ...
        TaskConstMeta get kCrateLaunchConstMeta => const TaskConstMeta(
            debugName: "launch",
            argNames: [],
        );
...
@protected Assignment dco_decode_assignment(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
switch (raw[0]) {
                case 0: return Assignment_Declare(name: dco_decode_String(raw[1]),value: dco_decode_box_autoadd_value(raw[2]),);
...
switch (raw[0]) {
                case 0: return Value_Number(dco_decode_f_64(raw[1]),);
case 1: return Value_String(dco_decode_String(raw[1]),);
case 2: return Value_Boolean(dco_decode_bool(raw[1]),);
                default: throw Exception("unreachable");
            } }
...
@protected Assignment sse_decode_assignment(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
...
return Assignment_Declare(name: var_name, value: var_value); default: throw UnimplementedError(''); }
             }
...
return Value_Number(var_field0);case 1: var var_field0 = sse_decode_String(deserializer);
return Value_String(var_field0);case 2: var var_field0 = sse_decode_bool(deserializer);
return Value_Boolean(var_field0); default: throw UnimplementedError(''); }
             }
...
@protected void sse_encode_assignment(Assignment self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
switch (self) { case Assignment_Declare(name: final name,value: final value): sse_encode_i_32(0, serializer); sse_encode_String(name, serializer);
...
switch (self) { case Value_Number(field0: final field0): sse_encode_i_32(0, serializer); sse_encode_f_64(field0, serializer);
case Value_String(field0: final field0): sse_encode_i_32(1, serializer); sse_encode_String(field0, serializer);
case Value_Boolean(field0: final field0): sse_encode_i_32(2, serializer); sse_encode_bool(field0, serializer);
  } }
