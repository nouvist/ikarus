...
fn wire__crate__init_app_impl(port_: flutter_rust_bridge::for_generated::MessagePort,ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,rust_vec_len_: i32,data_len_: i32)  {
            ...
            }fn wire__crate__launch_impl(port_: flutter_rust_bridge::for_generated::MessagePort,ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,rust_vec_len_: i32,data_len_: i32)  {
                FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec,_,_,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "launch", port: Some(port_), mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            deserializer.end(); move |context| async move {
                    transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>((move || async move {
                         let output_ok = crate::launch().await?;   Ok(output_ok)
                    })().await)
                } })
            }
...
return crate::vpl::ast::Assignment::Declare{name: var_name, value: var_value}; }
 _ => { unimplemented!(""); }}}
                }
...
2 => { let mut var_field0 = <bool>::sse_decode(deserializer);
...
// Codec=Dco (DartCObject based), see doc to use other codecs
            impl flutter_rust_bridge::IntoDart for crate::vpl::ast::Assignment {
                fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
                    match self {crate::vpl::ast::Assignment::Declare{name,value} => { [0.into_dart(),
...
impl flutter_rust_bridge::IntoIntoDart<crate::vpl::ast::Assignment> for crate::vpl::ast::Assignment {
...
// Codec=Dco (DartCObject based), see doc to use other codecs
            impl flutter_rust_bridge::IntoDart for crate::vpl::ast::Value {
                fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
                    match self {crate::vpl::ast::Value::Number(field0) => { [0.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
crate::vpl::ast::Value::String(field0) => { [1.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
crate::vpl::ast::Value::Boolean(field0) => { [2.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
 _ => { unimplemented!(""); }}
                }
            }
...
impl flutter_rust_bridge::IntoIntoDart<crate::vpl::ast::Value> for crate::vpl::ast::Value {
            fn into_into_dart(self) -> crate::vpl::ast::Value {
                ...
                impl SseEncode for crate::vpl::ast::Assignment {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {match self {crate::vpl::ast::Assignment::Declare{name,value} => { <i32>::sse_encode(0, serializer); <String>::sse_encode(name, serializer);
 ...
 _ => { unimplemented!(""); }}}
        ...
        for item in self { <u8>::sse_encode(item, serializer); }}
                ...
                impl SseEncode for crate::vpl::ast::Value {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {match self {crate::vpl::ast::Value::Number(field0) => { <i32>::sse_encode(0, serializer); <f64>::sse_encode(field0, serializer);
 }
crate::vpl::ast::Value::String(field0) => { <i32>::sse_encode(1, serializer); <String>::sse_encode(field0, serializer);
 }
crate::vpl::ast::Value::Boolean(field0) => { <i32>::sse_encode(2, serializer); <bool>::sse_encode(field0, serializer);
 }
 _ => { unimplemented!(""); }}}
                }
